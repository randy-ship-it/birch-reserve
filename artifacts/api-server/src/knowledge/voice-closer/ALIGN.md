...
## What Align is not (for this closer)

- Not a Birch ad product.
- Not “we sell you patients.”
- Not a place to quote CIM revenue / EBITDA / NDR / partner payouts on a Birch or Scale sales call (see NEVER-SAY).

## Voice routing

| Caller need | Route |
|-------------|-------|
| In-person MSP / put my book on Align / partner location | Align / Chris / Book a call |
| Digital bookings as a clinician on Scale rails | Scale `/providers` |
| Free store / audience monetize | Scale `/clinichubs` |
| Brand display seats | Birch Hold / Reserve / Book a call |
| On-prem clinic screens as ad surface | Book a call (custom IO; separate line) |
