...
**Mailing:** 777-2255B Queen St E, Toronto ON M4E 1G3  

No invented metrics. If a number is only on an investor CIM or diligence pack, do **not** recite it on Birch/Scale sales voice unless it is also on the approved public site and still not on NEVER-SAY.

## Core portfolio (live on rdgdh.com/portfolio JSON-LD / meta, fetched 2026-09-24)

| Name | URL | Public one-liner (from site / pack) |
|------|-----|-------------------------------------|
...
- URL: https://fridayapp.org  
- In-house CRM / Lane OS used across Scale lanes; public pilot.  
- Five portfolio workspaces: `rdgdh`, `alignwellness`, `scalehealth`, `silverbirchgrowth`, `birchreserve` (see friday-crm/docs/PORTFOLIO.md).  
- Named access: Randy (owner all), Jon (admin all), Simar (SBG + Scale), Chris (Align). Barb = Scale Connect intake path.

## Sister / bench products present in workspace (not all on RDGDH portfolio grid)
...
- Align CIM revenue / EBITDA / NDR / partner payouts.  
- RDGDH investor targets (e.g. “100MM pageviews by Dec 2026”) as **current Birch traffic**.  
- Cap table, s.85, Alset, bond, house stories.
