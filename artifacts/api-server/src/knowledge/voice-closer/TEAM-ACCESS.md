...
`https://birchreserve.net/sales/voice-demo`

- Audience: Randy / Jon / Simar / Chris / Barb only
- Not in public nav / footer / editorial sitemap
- Path under `/sales/` → robots `Disallow`; page `meta robots noindex,nofollow`
...
| team | rdgdh |
| console name | Untitled (Emma renaming / configuring Randy-voice) |
