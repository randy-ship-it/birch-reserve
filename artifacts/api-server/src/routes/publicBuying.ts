...
router.get("/llms.txt", (_req, res) => {
  res.type("text/plain").send(
    [
      "# Birch Reserve",
      "",
      "Institutional media access and pilot credits from USD $990.",
      "For health and wellness brands and their media agents.",
      "Ads sit inside signed Scale Health hubs, beside the private supplier catalog: DR-HO recovery equipment, Kalaya topical pain relief, Magnum Supps, Fresh Prep, LyfeFuel, RenPho, Flora Health, Resolve Sleep, and related products. The live example is physio.drhonow.com; other named hubs are signed and launching. The $990 Access Reserve is a category hold, not a live flight. No impression guarantee. Buyers may inquire or reserve; no reach should be inferred beyond the published contract.",
      `Formats: ${FORMATS.join(", ")}.`,
      "Canonical offers: reserve-990 ($990), pilot-4900 ($4,900), network-9900 ($9,900).",
      ...
      "Contact: randy@silverbirchgrowth.com",
    ].join("\n"),
  );
});
...
<div class="figures"><div class="figure">Starting at<strong>$990 USD</strong></div><div class="figure">Applied as credit<strong>100%</strong></div><div class="figure">Below published<strong>25%</strong></div></div>
...
<footer id="selectedSummary" class="fine"></footer>
<script>
